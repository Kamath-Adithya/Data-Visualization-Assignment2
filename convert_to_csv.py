...
def main():
    ...
    filePath = r"C:\Users\Steven\Documents\School\Fall 2019\Data Viz\Project 2\csvData"
    ...
    for participant in participantList:
        ...
        for ending in fileEndings:
            ...
            createCSV(participant, csvFile)
  

def createCSV(folder, fileName):
    # Open the CSV  
    ...
    print("CSV", fileName, "parsed!")  
    # Save the CSV
    with open(r"C:\Users\Steven\Documents\School\Fall 2019\Data Viz\Project 2\csvData\\" + folder + "\\"+ fileName + ".csv", 'w') as f:
